package com.cg.batch3.labWork9.Case;
...
public class EmployeeService<R> {
	...
	private static List<Department> dept = EmployeeRepository.getDepartments();;

	public static void main(String[] args) {
		EmployeeService<Object> obj = new EmployeeService<Object>();
		obj.sumOfSalary();
		obj.increaseSalary();
		obj.deptNameCount();
	...
	void deptNameCount() {
		...
		Map<Object, List<Employee>> map = stream1
				.collect(Collectors.groupingBy(i -> i.getDepartment().getDepartmentName()));
	...
	// � List employee name, hire date and day of week on which employee has
	// started.
	void listOfEmp() {
		Stream<Employee> stream1 = emp.stream();
	...
	// � List employee name, hire date and day of week for employee started on
	// Friday.
